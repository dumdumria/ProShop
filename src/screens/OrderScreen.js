...
function OrderScreen() {
    ...
    //     const script = document.createElement('script');
    //     script.type = 'text/javascript';
    //     script.src = `https://www.paypal.com/sdk/js?client-id=AX5ilYxhiiIMEt0kXbu6OUT4l0aBlBWbM6qlvlHWGna3EDtqTwbaEhtuRYUT0kVmqsnbBXyojxKf7CsB&currency=USD`
    //     script.async = true;
    //     script.onload = () => {
    //         setSdkReady(true);
    //     };
    ...
    // useEffect(() => {
    //     console.log('OrderScreen mounted, orderId:', orderId)
    ...
    //     } else if (order && !order.isPaid && !sdkReady) {
    //             if (!window.paypal) {
    //                 addPayPalScript()
    //             } else {
    //                 setSdkReady(true)
